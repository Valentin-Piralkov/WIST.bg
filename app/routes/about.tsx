...
export default function JobOffer() {
  return (
    <div className="flex flex-col justify-between items-center min-h-[100vh] h-full w-full bg-white">
      <IndexHeader />
      <div className="flex flex-row w-full px-40 py-12 min-h-[60vh] justify-between items-start gap-10">
        <div className="flex flex-col w-2/3 min-h-[60vh] justify-normal items-start gap-5">
          ...
          <h3 className="font-title font-bold text-2xl">За нас:</h3>
        ...
        <div className="flex flex-col w-1/3 min-h-[60vh] justify-between items-end gap-5">
